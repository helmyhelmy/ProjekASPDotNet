...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="m-content">
        <div class="form-group">
            <asp:HyperLink ID="ButangTambah" runat="server" CssClass="btn btn-primary" NavigateUrl="Add.aspx">Tambah</asp:HyperLink>
        </div>
        ...
        <asp:Repeater ID="ProgramRepeater" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "Edit.aspx?Id=" + Eval("Id") %>'>
                            <%# Eval("KodProgram") %>
                        </asp:HyperLink>
                    </td>
